       ...
       AUTHOR.        AWS.                                                      
      ******************************************************************
      * Program     : CBSTM02B.CBL                                      
      * Application : CardDemo                                          
      * Type        : BATCH COBOL Program                                
      * Function    : Generic routine to perform VSAM KSDS file handling   
      ******************************************************************
      ...
      ******************************************************************
      *  1. Open and close KSDS files
      *  2. Read files in sequential or random mode
      ******************************************************************        
      ...
      *****************************************************************         
       ...
       LINKAGE SECTION.                                                         
       01  LK-M02B-AREA.                                                        
           05  LK-M02B-DD          PIC X(08).                                   
           05  LK-M02B-OPER        PIC X(01).                                   
           ...
           05  LK-M02B-RC          PIC X(02).                                   
           05  LK-M02B-KEY         PIC X(25).                                   
           05  LK-M02B-KEY-LN      PIC S9(4).                                   
           05  LK-M02B-FLDT        PIC X(1000).                                 
                                                                                
       PROCEDURE DIVISION USING LK-M02B-AREA.                                   
       ...
       1000-TRNXFILE-PROC.                                                      
           ...
           IF M02B-READ                                                         
               READ TRNX-FILE INTO LK-M02B-FLDT                                 
               END-READ                                                         
               GO TO 1900-EXIT                                                  
           END-IF.                                                              
       ...
       1900-EXIT.                                                               
           MOVE TRNXFILE-STATUS TO LK-M02B-RC.                                  
       ...
       2000-XREFFILE-PROC.                                                      
           ...
           IF M02B-READ                                                         
               READ XREF-FILE INTO LK-M02B-FLDT                                 
               END-READ                                                         
               GO TO 2900-EXIT                                                  
           END-IF.                                                              
       ...
       2900-EXIT.                                                               
           MOVE XREFFILE-STATUS TO LK-M02B-RC.                                  
       ...
       3000-CUSTFILE-PROC.                                                      
           ...
           IF M02B-READ-K                                                       
               MOVE LK-M02B-KEY (1:LK-M02B-KEY-LN) TO FD-CUST-ID                
               READ CUST-FILE INTO LK-M02B-FLDT                                 
               END-READ                                                         
               GO TO 3900-EXIT                                                  
           END-IF.                                                              
       ...
       3900-EXIT.                                                               
           MOVE CUSTFILE-STATUS TO LK-M02B-RC.                                  
       ...
       4000-ACCTFILE-PROC.                                                      
           ...
           IF M02B-READ-K                                                       
               MOVE LK-M02B-KEY (1:LK-M02B-KEY-LN) TO FD-ACCT-ID                
               READ ACCT-FILE INTO LK-M02B-FLDT                                 
               END-READ                                                         
               GO TO 4900-EXIT                                                  
           END-IF.                                                              
       ...
       4900-EXIT.                                                               
           MOVE ACCTFILE-STATUS TO LK-M02B-RC.                                  
